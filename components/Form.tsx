    ...
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex-col gap-7 glassmorphism'>
        <label>
          ...
          <textarea value={post.prompt} onChange={(e) => setPost({...post, prompt: e.target.value})} placeholder='Write your prompt here...' className='form_textarea mb-6' required></textarea>
        </label>
        ...
        <label>
          ...
          <input value={post.tag} onChange={(e) => setPost({...post, tag: e.target.value})} placeholder='#tag' className='form_input mb-7' required />
        </label>
